  ...
  return (
    <footer className=" text-white bg-[#12126d] pt-12 ">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-3">
            ...
            <a href="#"  className="p-2 bg-pink-500 text-white rounded-full hover:bg-pink-600">
              <FaInstagram />
            </a>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-green-600">Our Priorities</a></li>
            <li><a href="#" className="hover:text-green-600">Our Gallery</a></li>
            <li><a href="#" className="hover:text-green-600">Contact Us</a></li>
            <li><a href="#" className="hover:text-green-600">About Us</a></li>
            <li><a href="#" className="hover:text-green-600">Donate Now</a></li>
            <li><a href="#" className="hover:text-green-600">Food Donation</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:text-green-600">Refund & Cancellation</a></li>
            <li><a href="#" className="hover:text-green-600">Legality</a></li>
            <li><a href="#" className="hover:text-green-600">Disclaimer</a></li>
          </ul>
        </div>
      ...
      <div className="text-center py-6 mt-8 border-t border-gray-300">
        &copy; 2025 Shrimati Anita Devi Foundation. All rights reserved.
      </div>
    </footer>
  );
};
